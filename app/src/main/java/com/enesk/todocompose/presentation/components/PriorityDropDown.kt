...
import com.enesk.todocompose.presentation.ui.theme.PRIORITY_DROP_DOWN_HEIGHT
...
fun PriorityDropDown(
    ...
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .size(PRIORITY_DROP_DOWN_HEIGHT)
...
@Preview
@Composable
fun PriorityDropDownPreviewTurkish() {
    PriorityDropDown(
...
@Preview(locale = "en ")
@Composable
fun PriorityDropDownPreviewEnglish() {
    PriorityDropDown(
        priority = Priority.HIGH,
        onPrioritySelected = {}
    )
